...
ActiveRecord::Schema.define(version: 20140311190612) do
  ...
  create_table "default_shipping_categories", force: true do |t|
  end
  ...
  add_index "spree_blendable_products_taxons", ["blendable_taxon_id"], name: "index_products_blendable_taxons_on_taxon_id", using: :btree
  add_index "spree_blendable_products_taxons", ["product_id"], name: "index_products_blendable_taxons_on_product_id", using: :btree
  ...
  create_table "spree_email_invoice_items", force: true do |t|
    t.string   "sku"
    t.string   "name"
    t.integer  "count"
  ...
  create_table "spree_email_invoices", force: true do |t|
    t.string   "subject"
  ...
  create_table "spree_shipworks_sync_statuses", force: true do |t|
    t.integer  "order_id"
  ...
  create_table "spree_sweepstakes", force: true do |t|
    t.string   "name"
    t.date     "starts_at"
    t.date     "expires_at"
    t.datetime "created_at",  null: false
  ...
  create_table "spree_sync_statuses", force: true do |t|
    t.integer  "order_id"
    t.boolean  "sent_to_shipworks"
    t.boolean  "updated_by_shipworks"
    t.datetime "created_at"
